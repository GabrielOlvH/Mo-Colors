...
public class ColoredWoolBakedModel extends ColoredBakedModel {

    private BakedModel woolBakedModel;
    private Sprite sprite;
    private final SpriteIdentifier spriteId = new SpriteIdentifier(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, new Identifier("block/white_wool"));
    ...
    public @Nullable BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        woolBakedModel = loader.getOrLoadModel(new Identifier("block/white_wool")).bake(loader, textureGetter, rotationContainer, modelId);
