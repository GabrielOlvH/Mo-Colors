...
public class ColoredSlimeBakedModel extends ColoredBakedModel {

    private BakedModel glassBakedModel;
    private Sprite sprite;
    private final SpriteIdentifier spriteId = new SpriteIdentifier(PlayerScreenHandler.BLOCK_ATLAS_TEXTURE, new Identifier(MoColors.MOD_ID, "block/gray_slime_block"));
    ...
    public @Nullable BakedModel bake(ModelLoader loader, Function<SpriteIdentifier, Sprite> textureGetter, ModelBakeSettings rotationContainer, Identifier modelId) {
        glassBakedModel = loader.getOrLoadModel(new Identifier(MoColors.MOD_ID, "block/colored_slime")).bake(loader, textureGetter, rotationContainer, modelId);
